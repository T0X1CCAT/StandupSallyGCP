...
public class UtilsTest {
    ...
    void convertChannelToUsersStringToMapTest() {
        ...
        Map<String, List<String>> channelToUserMap = Utils.convertChannelToUsersStringToMap(channelToUserString);
        ...
        channelToUserMap = Utils.convertChannelToUsersStringToMap(channelToUserString);
    ...
    void convertChannelIdToUserHandleStringToMapTest() {
        ...
        Map<String, String> channelIdToUserHandleMap = Utils.convertChannelIdToUserHandleStringToMap(channelIdToUserHandleString);
    ...
    void generateSecretStringFromMapTest() {
        ...
        String secretString = Utils.generateSecretStringFromMap(lastUsersToRunStandupInEachChannelMap);
        assertEquals("channel1=@felix,channel2=@peter", secretString);

        lastUsersToRunStandupInEachChannelMap.clear();
        lastUsersToRunStandupInEachChannelMap.put( "channel2", "@peter");
        secretString = Utils.generateSecretStringFromMap(lastUsersToRunStandupInEachChannelMap);
